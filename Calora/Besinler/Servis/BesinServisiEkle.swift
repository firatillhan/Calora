...
enum BesinServisiEkle {
    
    static func besinEkle(
        isim: String,
        kalori: Int,
        ...
        let adres = Config.apiBaseURL + "calora_list.php?action=besin_ekle"
        ...
        print("SUNUCU CEVABI:", String(data: veri, encoding: .utf8) ?? "")
